...
def plot_probs(iterations):
    ...
    # Plot results
    plt.plot(num_PEOPLE, prob, 'k-', label='Theoretical prob.')
    plt.plot(num_PEOPLE, sample_prob, 'bo-', label='Empirical prob.')
